...
import 'package:personalexpanses/widgets/chart_bar.dart';
          ...
          children: groupedTransactionsValue.map((data) {
            return Flexible(
             ...
             child: ChartBar(label:data['day'], spendingAmount:data['amount'],
              spendingPctTotal:  totalSpending == 0.0 ? 0.0 :  (data['amount'] as double) / totalSpending,),
            );
          }).toList(),
        ),
      ),
